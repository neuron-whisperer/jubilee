...
### App Class Fields and Methods
    ...
    set_mode(mode, new_mode_parameters=None)   # mode = name or Mode object
...
Fonts can be a pygame.font.SysFont, a font name, or None for default font.
    ...
    draw_text_center(text, y=None, color=None, font=None, dest=None)  # default=screen center
...
### Surfaces and Images
    ...
    load_sound(path)                           # loads an individual image at path 
    ...
    scale_image(image, x_scale, y_scale=None)  # default=proportional; specify y for per-axis
    ...
    start_display_fade(steps=None, color='black', end_mode=None, end_parameters=None)
        # positive duration fades in; negative duration fades out and then calls set_mode()
...
### Fonts
	...
	change_font()						# choose next font in font list as current font
...
### Example Mode
	...
	class Example_Mode(Mode):
        ...
        def enter(self, mode_parameters: dict=None):
		      """ Mode entry method, with a provided set of mode_parameters for context. """
...
### Controls
    Button(app, x, y, width, height, caption,
        target_mode=None, target_mode_parameters=None,
        click=None, hold=None, release=None, app_exit=False,
        font=None, color='white', background_color=None, parameters=None)
        
    HoldButton(app, x, y, width, height, caption,
        hold_duration=25, hold_color='red', hold_complete=None,
...
### Worker Class Fields and Methods
	...
	change_font(font_name)						 # changes standard font
